...
<!--   <a href="https://github.com/othneildrew/Best-README-Template"> -->
    <img src="https://github.com/Elaf24/WeatherApp-IOS/assets/110555263/68667557-2ec8-4ec1-a9d7-4cda6ca3db22" height="400" width="400">
...
It is an app that uses openweathermap  API to collect weather data of an area and shows the weather conditions of that area.
It has dark and light mode as well.
...
1.Clone the repository:
  ...
  ```sh
https://github.com/Elaf24/WeatherApp-IOS.git
  ```



2.NOTE: You will need your own API Key.Get it from here
